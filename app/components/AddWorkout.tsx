...
export default function AddWorkout() {
    ...
    const [exercise, setExercise] = useState<exerciseType>({image: "", name: "", description: "", setIsAdded: (f: any) => f});
    ...
    const handleSubmit = (e: any) => {
        ...
        setWeight(0);
        setNotes("")
        setExercise({image: "", name: "", description: "", setIsAdded: (f: any) => f});
        setIsAdded(false);
    };
    ...
    return (
        <div className="p-10 bg-gray-300 flex flex-col justify-center items-center select-none">
            ...
            <form onSubmit={(e) => handleSubmit(e)} className="grid grid-cols-2 justify-center items-center w-8/10 gap-2 bg-gray-200 px-5 py-10 rounded-xl shadow-xl shadow-gray-400">
                ...
                <div className="col-span-2">
                    {showExercises && <ExerciseList props={{exercise, setExercise, isAdded, setIsAdded}}/>}
                </div>
